        ...
        <tr>
            ...
            @foreach($user as $u)
                ...
                <td style="line-height: 50px" class="center">
                    ...
                    <a href="#" onclick='editUser("{{$u->id}}")' style="padding: 5px;" data-toggle="modal" data-target="#editUser"><i class="fa fa-edit" style="color: #f39c12;"></i></a>
                    <a href="#" onclick='resetPassword("{{$u->id}}")' data-toggle="modal" data-target=".bs-example-modal-sm" style="padding: 5px;"><i class="fa fa-refresh" style="color: #00a65a;"></i></a>
                    <a href="#" style="padding: 5px;" onclick='deleteUser("{{$u->id}}")'><i class="fa fa-trash" style="color: red;"></i></a>
                    <a href="#" onclick='viewUser("{{$u->id}}")' style="padding: 5px;" data-toggle="modal" data-target="#viewUser" style="padding: 5px;"><i class="fa fa-eye" style="color: #00c0ef"></i></a>
